...
=item B<convert [--object> I<objectdef>B<] [--image-opts] [--target-image-opts] [-U] [-c] [-p] [-q] [-n] [-f> I<fmt>B<] [-t> I<cache>B<] [-T> I<src_cache>B<] [-O> I<output_fmt>B<] [-B> I<backing_file>B<] [-o> I<options>B<] [-l> I<snapshot_param>B<] [-S> I<sparse_size>B<] [-m> I<num_coroutines>B<] [-W]> I<filename> B<[>I<filename2> B<[...]]> I<output_filename>
...
C<k> for kilobytes. If this option is used, copy offloading will not be
attempted.
...
=item B<amend [--object> I<objectdef>B<] [--image-opts] [-p] [-p] [-f> I<fmt>B<] [-t> I<cache>B<] -o> I<options>B< >I<filename>
